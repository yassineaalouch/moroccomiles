...
export const metadata: Metadata = {
  ...
  description: "Fifteen curated MoroccoMiles journeys across the Sahara, High Atlas and Atlantic coast.",
        ...
        <div className="relative mx-auto flex min-h-[58vh] max-w-[1500px] items-end px-5 pb-16 pt-36 sm:px-8 sm:pb-20 lg:px-12">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-xl font-sans text-sm leading-relaxed tracking-wide text-morocco-sand/75">
              Desert expeditions, High Atlas passages and Atlantic medina roads—each with a clear day-by-day rhythm.
            </p>
          </div>
        </div>
      </section>
