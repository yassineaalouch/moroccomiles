...
type PageProps = {
  searchParams: { tour?: string | string[] };
};
...
export function generateMetadata({ searchParams }: PageProps): Metadata {
  const tour = getTour(queryValue(searchParams.tour) ?? "");
  if (!tour) {
  ...
  return buildPageMetadata({
    ...
    description: `Request ${tour.title}, a ${tour.duration.toLowerCase()} private MoroccoMiles journey. Share your dates and how many travelers will join.`,
    path: `/book`,
    image: getTourOgImage(tour),
